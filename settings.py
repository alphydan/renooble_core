...
SECRET_KEY = "$sbibo_l6glg$w0dxf6+gmk492wf#q0=eae1p9g+_je792-mtd"
...
TEMPLATE_CONTEXT_PROCESSORS = [
    ...
    "renooble.context_processors.combined_inbox_count",
]
