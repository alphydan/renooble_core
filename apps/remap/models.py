...
# General project information
    projectName = models.CharField("Project Name", max_length=100, help_text="Please give your installation a name. Your entry will be listed at re.nooble under this name.") # Mandatory info
    projectDescription = models.TextField("Project Description", blank=True, null=True, help_text="Please summarize and describe your project.") # voluntary
    ...
    AEP = models.DecimalField("Annual energy production in kWh", max_digits=10, decimal_places=4, null=True, blank=True, help_text="What is the annual energy production (AEP) of your installation? Only answer if your installation is running more than one year.") # in kWh User information, voluntary
    ...
    technologyType=models.CharField("Renewable Resource", max_length = 5, choices=TECHNOLOGIES, help_text="What type of renewable energy device have you installed?") # User information, voluntary
    PROJECT_BUILDING = (
            ('PRHO', 'Private House'),
            ('APART', 'Apartment'),
            ('SCHOO', 'School'),
    ...
    projectBuilding = models.CharField("Property of installation", max_length=10, choices = PROJECT_BUILDING, blank=True, null=True, help_text="At what kind of property did you install the renewable energy device?") # User information, voluntary
    GRID=(
            ('ON', 'Grid Connected'),
    ...
    commercialInstallation = models.BooleanField("Commercial installation", default=False, help_text="Please check this box if your installation of larger scale (more than 500kW) or if you have a power-purchase agreement with a third-party?") # User information, voluntary

#####
# User information
    # userID = models.ForeignKey(User)
    userEmail = models.EmailField("Contact email", help_text="What is your email address? You can modify your listing by using your email on the renooble website.") # mandatory, if empty, we create a new user account 
    entryDate = models.DateTimeField()  # automatically set in the views.py
    agreementToTerms = models.BooleanField("Agreement to terms", default=False, help_text="Please review the terms.") # mandatory

#####
# Misc information
    userComments = models.TextField("Your comments", blank=True, null=True, help_text="Do you have any comments about your installation to share with other interested users? Where you satisfied with your investment?") # voluntary
